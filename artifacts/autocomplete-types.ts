...
export const METHOD_SUGGESTIONS: DataMakerMethod[] = [
  ...
  },
  {
    ...
    kind: CompletionItemKind.Method,
    insertText: "create_scenario_file(${1:name}: str, ${2:content}: any, ${3:scenario_id}: str, ${4:team_id}: str, ${5:project_id}: Optional[str], ${6:description}: Optional[str], ${7:mime_type}: Optional[str], ${8:folder_id}: Optional[str])",
    documentation: "Create/upload a new file in a scenario.",
  ...
  },
  {
    ...
    kind: CompletionItemKind.Method,
    insertText: "upload_scenario_file_from_path(${1:file_path}: str, ${2:scenario_id}: str, ${3:team_id}: str, ${4:project_id}: Optional[str], ${5:name}: Optional[str], ${6:description}: Optional[str], ${7:folder_id}: Optional[str])",
    documentation: "Upload a file from a local path to a scenario.",
