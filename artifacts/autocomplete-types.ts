...
export const METHOD_SUGGESTIONS: DataMakerMethod[] = [
  ...
  },
  {
    ...
    kind: CompletionItemKind.Method,
    insertText: "get_scenario_file(${1:file_id}: str)",
    documentation: "Get metadata for a specific file by ID.",
  ...
  },
  {
    ...
    kind: CompletionItemKind.Method,
    insertText: "download_scenario_file(${1:file_id}: str)",
    documentation: "Download a file's content by ID.",
  ...
  },
  {
    ...
    kind: CompletionItemKind.Method,
    insertText: "download_scenario_file_to_path(${1:file_id}: str, ${2:destination_path}: str)",
    documentation: "Download a file and save it to a local path.",
  ...
  },
  {
    ...
    kind: CompletionItemKind.Method,
    insertText: "upload_scenario_file_from_path(${1:file_path}: str, ${2:scenario_id}: Optional[str], ${3:team_id}: Optional[str], ${4:project_id}: Optional[str], ${5:name}: Optional[str], ${6:description}: Optional[str], ${7:folder_id}: Optional[str])",
    documentation: "Upload a file from a local path to a scenario.  Args:     file_path: Path to the local file to upload.     scenario_id: Optional scenario ID. Falls back to DATAMAKER_SCENARIO_ID env var.     team_id: Optional team ID. Falls back to DATAMAKER_TEAM_ID env var.     project_id: Optional project ID. Falls back to DATAMAKER_PROJECT_ID env var.     name: Optional filename. If not provided, uses the original filename.     description: Optional description of the file.     folder_id: Optional folder ID to place the file in.  Returns:     The created file metadata dictionary.",
  ...
  },
  {
    ...
    documentation: "Delete a file by ID.",
