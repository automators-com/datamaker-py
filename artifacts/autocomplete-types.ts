...
export const METHOD_SUGGESTIONS: DataMakerMethod[] = [
  ...
  },
  {
    label: "get_sets",
    kind: CompletionItemKind.Method,
    insertText: "get_sets(${1:project_id}: Optional[str])",
    documentation: "Get all saved sets for the caller's project/team scope.  Args:     project_id: Optional project ID to scope the listing to. Falls back         to the DATAMAKER_PROJECT_ID env var.  Returns:     A list of set metadata dictionaries.",
    detail: "Method: get_sets",
    sortText: "get_sets",
  },
  {
    label: "get_set",
    kind: CompletionItemKind.Method,
    insertText: "get_set(${1:set_id}: str)",
    documentation: "Get a single saved set by ID, including its full rows payload.  Args:     set_id: The unique identifier of the set.  Returns:     The set dictionary (including its saved rows in ``data``).",
    detail: "Method: get_set",
    sortText: "get_set",
  },
  {
    label: "create_set",
    kind: CompletionItemKind.Method,
    insertText: "create_set(${1:name}: str, ${2:data}: any, ${3:description}: Optional[str], ${4:row_count}: Optional[int], ${5:project_id}: Optional[str])",
    documentation: "Create (save) a new set.  Args:     name: A name for the saved set.     data: The rows payload to save - typically a list of row dicts.     description: Optional short description of what the set captures.     row_count: Optional explicit row count (derived from data otherwise).     project_id: Optional project ID. Falls back to DATAMAKER_PROJECT_ID.  Returns:     The created set dictionary.",
    detail: "Method: create_set",
    sortText: "create_set",
  },
  {
    label: "update_set",
    kind: CompletionItemKind.Method,
    insertText: "update_set(${1:set_id}: str, ${2:name}: Optional[str], ${3:description}: Optional[str], ${4:data}: any, ${5:row_count}: Optional[int])",
    documentation: "Update a saved set.  Args:     set_id: The unique identifier of the set to update.     name: New name for the set.     description: New description.     data: Replacement rows payload.     row_count: Explicit row count override.  Returns:     The updated set dictionary.",
    detail: "Method: update_set",
    sortText: "update_set",
  },
  {
    label: "delete_set",
    kind: CompletionItemKind.Method,
    insertText: "delete_set(${1:set_id}: str)",
    documentation: "Delete a saved set by ID.  Args:     set_id: The unique identifier of the set to delete.  Returns:     Confirmation response.",
    detail: "Method: delete_set",
    sortText: "delete_set",
  },
  {
    label: "save_set",
    kind: CompletionItemKind.Method,
    insertText: "save_set(${1:name}: str, ${2:data}: any, ${3:description}: Optional[str], ${4:project_id}: Optional[str])",
    documentation: "Convenience method to save rows as a named set.  Project context is pulled from DATAMAKER_PROJECT_ID when not provided, which is convenient inside DataMaker sandbox environments.  Args:     name: A name for the saved set.     data: The rows to save - typically a list of row dicts.     description: Optional short description of what the set captures.     project_id: Optional project ID. Falls back to DATAMAKER_PROJECT_ID.  Returns:     The created set dictionary.  Example:     >>> dm = DataMaker()     >>> rows = dm.generate(template)     >>> result = dm.save_set(\"nightly-regression\", rows)     >>> print(f\"Saved set: {result['name']} ({result['rowCount']} rows)\")",
