...
class TestDataMaker:
    ...
    @patch('src.datamaker.routes.generation.GenerationClient.generate')
    def test_generate_from_template_id(self, mock_generate, mock_get_template, 
                                     datamaker_client, sample_template):
    ...
    def test_create_template(self, mock_create_template, datamaker_client, sample_template):
        ...
        mock_create_template.assert_called_once_with(sample_template, project_id, team_id)
    ...
    def test_update_template(self, mock_update_template, datamaker_client, sample_template):
    ...
    def test_create_api_key(self, mock_create_api_key, datamaker_client):
        ...
        mock_create_api_key.assert_called_once_with("test-key", "user", "Test Key", None)
    ...
    def test_create_connection(self, mock_create_connection, datamaker_client, sample_connection):
    ...
    def test_test_connection(self, mock_test_connection, datamaker_client, sample_connection):
    ...
    def test_create_project(self, mock_create_project, datamaker_client, sample_project):
    ...
    def test_get_current_user(self, mock_get_current_user, datamaker_client, sample_user):
    ...
    @patch('src.datamaker.routes.export_and_validation.ValidationClient.validate_api_key')
